    ...
    public partial class dbInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "How to be a better mentor", new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2877), "ahihi", 1, 2L });

            migrationBuilder.InsertData(
                table: "Conversation",
                columns: new[] { "Id", "CreateAt", "Duration", "EndTime", "IsClose", "LastMessage", "User1Id", "User2Id" },
                values: new object[] { 1L, new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(3016), new TimeSpan(0, 0, 0, 0, 0), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "Hello!", 1L, 2L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, "Great post!", new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2903), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "Hello!", 1L, new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(3060), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 1L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, "How to sort an array in C#?", new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2634), "ahihi", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1L, 1 });

            migrationBuilder.InsertData(
                table: "StudentSubcription",
                columns: new[] { "Id", "CurrentMeeting", "CurrentQuestion", "EndDate", "StartDate", "Status", "StudentId", "SubcriptionId" },
                values: new object[] { 1L, 0, 0, new DateTime(2024, 7, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2714), new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2713), true, 1L, 1L });

            migrationBuilder.InsertData(
                table: "Transaction",
                columns: new[] { "Id", "Ammount", "CreateTime", "Description", "Type", "WalletId" },
                values: new object[] { 1L, 9.9900000000000002, new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2824), "Subscription payment", "Deposit", 1L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(3098), "like", 2L });

            migrationBuilder.InsertData(
                table: "Order",
                columns: new[] { "Id", "CreateDate", "Description", "Money", "PaymentCode", "Status", "TransactionId" },
                values: new object[] { 1L, new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2865), "Payment for Basic subscription", 9.9900000000000002, "PAY12345", true, 1L });

            migrationBuilder.InsertData(
                table: "QuestionComment",
                columns: new[] { "Id", "Content", "CreateDate", "ModifiedDate", "QuestionId", "Status", "UserId" },
                values: new object[] { 1L, "Good question!", new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2986), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1L, false, 2L });
