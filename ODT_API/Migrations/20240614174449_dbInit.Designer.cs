...
namespace ODT_API.Migrations
{
    ...
    [Migration("20240614174449_dbInit")]
            ...
            modelBuilder.Entity("ODT_Repository.Entity.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2877),
                            Image = "ahihi",
                            TotalLike = 1,
                            UserId = 2L
                        });
            ...
            modelBuilder.Entity("ODT_Repository.Entity.BlogComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BlogId = 1L,
                            Comment = "Great post!",
                            CreateDate = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2903),
            ...
            modelBuilder.Entity("ODT_Repository.Entity.Conversation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateAt = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(3016),
            ...
            modelBuilder.Entity("ODT_Repository.Entity.ConversationMessage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "Hello!",
                            ConversationId = 1L,
                            CreateTime = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(3060),
            ...
            modelBuilder.Entity("ODT_Repository.Entity.MessageReaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(3098),
                            ReactionType = "like",
                            UserId = 2L
                        });
                });
            ...
            modelBuilder.Entity("ODT_Repository.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2865),
            ...
            modelBuilder.Entity("ODT_Repository.Entity.Question", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2634),
                            Image = "ahihi",
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = false,
                            StudentId = 1L,
            ...
            modelBuilder.Entity("ODT_Repository.Entity.QuestionComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2986),
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            QuestionId = 1L,
                            Status = false,
                            UserId = 2L
            ...
            modelBuilder.Entity("ODT_Repository.Entity.StudentSubcription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentMeeting = 0,
                            CurrentQuestion = 0,
                            EndDate = new DateTime(2024, 7, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2714),
                            StartDate = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2713),
                            Status = true,
                            StudentId = 1L,
                            SubcriptionId = 1L
                        });
            ...
            modelBuilder.Entity("ODT_Repository.Entity.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 6, 15, 0, 44, 47, 127, DateTimeKind.Local).AddTicks(2824),
